...
public enum _eChestConfigs implements StringRepresentable {
    ...
    _eChestConfigs(int size, int rowLength, int xSize, int ySize, int textureXSize, int textureYSize) {
        this(null, size, rowLength, xSize, ySize, textureXSize, textureYSize);
    }

    _eChestConfigs(@Nullable String name, int size, int rowLength, int xSize, int ySize, int textureXSize, int textureYSize) {
        this.name = name;
        this.size = size;
    ...
    public static List<Block> get(_eChestConfigs type) {
        return switch (type) {
