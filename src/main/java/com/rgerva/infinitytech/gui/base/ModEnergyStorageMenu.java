...
public abstract class ModEnergyStorageMenu<T extends ModEnergyStorageBlockEntity<?>> extends AbstractContainerMenu implements IModEnergyStorageMenu {

    protected final T blockEntity;
    protected final Level level;
    protected final Block blockType;

    protected ModEnergyStorageMenu(@Nullable MenuType<?> menuType, int id, Inventory playerInventory, BlockEntity blockEntity, Block blockType) {
        this(menuType, id, playerInventory, blockEntity, blockType, 8, 84);
    }

    protected ModEnergyStorageMenu(@Nullable MenuType<?> menuType, int id, Inventory playerInventory,
                                   BlockEntity blockEntity, Block blockType,int playerInventoryX, int playerInventoryY) {
        super(menuType, id);
