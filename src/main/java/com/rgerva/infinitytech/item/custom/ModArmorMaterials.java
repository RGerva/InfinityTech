...
public class ModArmorMaterials {
    public static final ArmorMaterial TITANIUM_ARMOR_MATERIAL = new ArmorMaterial(1796,
            ...
            1.5f, 0.05f, ModTags.Items.TITANIUM_REPAIR,
            ResourceLocation.fromNamespaceAndPath(InfinityTech.MOD_ID, "titanium"));
}
