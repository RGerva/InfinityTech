...
public class ObsidianChestBlockEntity extends _ModChestBlockEntity {
    public ObsidianChestBlockEntity(BlockPos pos, BlockState blockState) {
        super(ModBlockEntities.CHEST_OBSIDIAN_ENTITY.get(), pos, blockState, _eChestConfigs.OBSIDIAN);
    }

    @Override
    protected AbstractContainerMenu createMenu(int i, Inventory inventory) {
        return new ModChestMenu(ModGUI.CHEST_OBSIDIAN_MENU.get(), i, inventory, this, _eChestConfigs.OBSIDIAN);
    }
