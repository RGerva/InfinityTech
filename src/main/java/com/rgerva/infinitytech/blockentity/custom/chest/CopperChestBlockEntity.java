...
public class CopperChestBlockEntity extends _ModChestBlockEntity {
    public CopperChestBlockEntity(BlockPos pos, BlockState blockState) {
        super(ModBlockEntities.CHEST_COPPER_ENTITY.get(), pos, blockState, _eChestConfigs.COPPER);
    }

    @Override
    protected AbstractContainerMenu createMenu(int containerId, Inventory inventory) {
        return new ModChestMenu(ModGUI.CHEST_COPPER_MENU.get(), containerId, inventory, this, _eChestConfigs.COPPER);
    }
