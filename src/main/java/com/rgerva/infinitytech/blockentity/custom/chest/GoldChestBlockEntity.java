...
public class GoldChestBlockEntity extends _ModChestBlockEntity {
    public GoldChestBlockEntity(BlockPos pos, BlockState blockState) {
        super(ModBlockEntities.CHEST_GOLD_ENTITY.get(), pos, blockState, _eChestConfigs.GOLD);
    }

    @Override
    protected AbstractContainerMenu createMenu(int i, Inventory inventory) {
        return new ModChestMenu(ModGUI.CHEST_GOLD_MENU.get(), i, inventory, this, _eChestConfigs.GOLD);
    }
