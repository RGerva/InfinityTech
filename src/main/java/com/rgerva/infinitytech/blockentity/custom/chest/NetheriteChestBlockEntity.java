...
public class NetheriteChestBlockEntity extends _ModChestBlockEntity {
    public NetheriteChestBlockEntity(BlockPos pos, BlockState blockState) {
        super(ModBlockEntities.CHEST_NETHERITE_ENTITY.get(), pos, blockState, _eChestConfigs.NETHERITE);
    }

    @Override
    protected AbstractContainerMenu createMenu(int i, Inventory inventory) {
        return new ModChestMenu(ModGUI.CHEST_NETHERITE_MENU.get(), i, inventory, this, _eChestConfigs.NETHERITE);
    }
